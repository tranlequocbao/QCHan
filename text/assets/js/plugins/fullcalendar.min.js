        ...
        var i = n(2),
            ...
            p = function(t) {
                ...
                return i.__extends(e, t), e.prototype._getView = function() {
                    ...
                    this.calendar.freeze(), this.addScroll(this.queryScroll())
                }, e.prototype.onRenderQueueStop = function() {
                    this.calendar.updateViewSize() && this.popScroll(), this.calendar.thaw()
        ...
        var r = n(3),
            ...
            H = function() {
                ...
                return t.prototype.constructed = function() {}, t.prototype.getView = function() {
                    ...
                    var e, n = this.view;
                    this.freeze(), n && t && n.type !== t && this.clearView(), !this.view && t && (e = this.view = this.viewsByType[t] || (this.viewsByType[t] = this.instantiateView(t)), this.bindViewHandlers(e), e.startBatchRender(), e.setElement(r("<div class='fc-view fc-" + t + "-view' />").appendTo(this.contentEl)), this.toolbarsManager.proxyCall("activateButton", t)), this.view && (this.view.get("businessHourGenerator") !== this.businessHourGenerator && this.view.set("businessHourGenerator", this.businessHourGenerator), this.view.setDate(this.currentDate), e && e.stopBatchRender()), this.thaw()
                    ...
                    var t = this.view,
                        e = t.queryScroll();
                    this.freeze(), this.clearView(), this.calcSize(), this.renderView(t.type), this.view.applyScroll(e), this.thaw()
                    ...
                    return "auto" === this.opt("") || "auto" === this.opt("height")
                ...
                }, t.prototype.forceFreeze = function() {
                    this.contentEl.css({
                        width: "100%",
                    ...
                    this.freezeDepth--, this.contentEl.css({
                        width: "",
                        height: "",
                        overflow: ""
                    }), this.freezeDepth && this.forceFreeze()
